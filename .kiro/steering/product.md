...
- Garden map (`/gartenkarte`): upload a garden image, click to place plants with percentage-based coordinates, colored markers with tooltips
...
- Filtering by category, event type, and month on plant list, observation list, and event list
